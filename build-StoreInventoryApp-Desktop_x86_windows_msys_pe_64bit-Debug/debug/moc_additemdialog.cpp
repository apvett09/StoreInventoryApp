...
#include <memory>
#include "../../StoreInventoryApp/additemdialog.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_AddItemDialog_t, stringdata0) + ofs), len 
...
const QMetaObject AddItemDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_AddItemDialog.offsetsAndSize,
